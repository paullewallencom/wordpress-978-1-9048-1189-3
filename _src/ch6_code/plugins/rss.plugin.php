...
Plugin URI: http://hasin.wordpress.com/
Description: A plugin that aggregates RSS and parse to show it, You can use it in any post of any page
Author: Hasin Hayder
Version: 2.0 
...
sample formats of the {rss} tag 
	1. {rss uri=http://rss.groups.yahoo.com/group/phpexperts/rss count=5}
	2. {rss uri=http://phpxperts.com/hasin/wp-rss2.php count=10}

there are 2 attribute in this {rss} tag which we look for
	1. uri = rss feed location
	2. counter = how many feed to show
...
{
	$rss = new lastRSS();
	//print_r($rss->Get("http://localhost/wp/feed/"));
